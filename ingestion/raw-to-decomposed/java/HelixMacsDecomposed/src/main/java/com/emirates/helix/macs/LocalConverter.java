...
public class LocalConverter {
    ...
    */
    ...
    public static void main(String[] args) throws IOException {
    	...
    	String xsdPath="D:\\UDAYKUMARREDDY\\HelixWorkspace\\xmlavro\\xml\\Books.xsd";
    	String xmlPath="D:\\UDAYKUMARREDDY\\HelixWorkspace\\xmlavro\\xml\\Books.xml";
    	String avscPath="D:\\UDAYKUMARREDDY\\HelixWorkspace\\xmlavro\\xml\\Books.avsc";
    	String avroPath="D:\\UDAYKUMARREDDY\\HelixWorkspace\\xmlavro\\xml\\Books.avro";
    	
    	   File xsdFile = new File(xsdPath);
    	   File xmlFile = new File(xmlPath);
    	   File avscFile = new File(avscPath);
          ...
          DatumBuilder datumBuilder = new DatumBuilder(schema);
          Object datum = datumBuilder.createDatum(xmlFile);
