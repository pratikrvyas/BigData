...
public class SeqXmlToAvroConverterJob extends Configured implements Tool {
 
	// load schema of avro output 
	public static final Schema schema = createSchema();
	private static Schema createSchema() {
	    try {
	    	//Logger.getGlobal().info("Loading schema from path -> " + schemaFile.getAbsolutePath());
...
**********/	  
      ...
      job.setJarByClass(SeqXmlToAvroConverterJob.class);
    ...
    public static void main(String[] args) throws Exception {
    	...
    	int exitCode = ToolRunner.run(new Configuration(), new SeqXmlToAvroConverterJob(), args);
