...
trait FlightPayloadUtils {
  ...
  val COLUMNLIST_flight_act_payload_details= List("ZFW","MZFW","TOW","MTOW","LWT","MLWT","DOW","DOI","LIZFW","MACLIZFW","LITOW","MACTOW","total_compartment_weight","underload","total_payload","final_version_num","msg_received_date")

  val COLUMNLIST_flight_pln_payload_details = List("ELWT", "MAX_TAXI_WT", "MLWT","ETOW", "MTOW", "EZFW", "MZFW", "lido_version_num", "msg_received_date")
  ...
  val COLUMNLIST_flight_deadload_details = List("baggage_weight","total_excess_bag_weight","cargo_weight","mail_weight","transit_weight","miscl_weight","msg_received_date")
  /**
