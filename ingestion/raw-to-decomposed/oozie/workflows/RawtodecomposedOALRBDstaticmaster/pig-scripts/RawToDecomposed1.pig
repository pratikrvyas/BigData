...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS Airline_2_letter_BCD_Code,(chararray)$1 AS Airline_numeric_number,(chararray)$2 AS OAL_Cabin,(chararray)$3 AS EK_Cabin,(chararray)$4 AS Effective_Start_Date,(chararray)$5 AS  Effective_End_Date;
