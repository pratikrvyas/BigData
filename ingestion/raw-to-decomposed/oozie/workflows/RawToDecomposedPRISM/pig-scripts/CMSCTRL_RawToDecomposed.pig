...
rawdatadelimited =  FOREACH rawdata  GENERATE (chararray)$0 AS Processed_Month,(chararray)$1 AS No_Of_Records,(chararray)$2 AS total_flights,(chararray)$3 AS total_base_amount;
