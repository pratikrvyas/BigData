...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS AREA_ID,(chararray)$1 AS ISO_CODE,(chararray)$2 AS REGION_NAME,(chararray)$3 AS COUNTRY_NAME,(chararray)$4 AS IATA_AREA,(chararray)$5 AS  CREATED_DATE,(chararray)$6 AS UPDATED_DATE,(chararray)$7 AS CREATED_BY,(chararray)$8 AS UPDATED_BY;
