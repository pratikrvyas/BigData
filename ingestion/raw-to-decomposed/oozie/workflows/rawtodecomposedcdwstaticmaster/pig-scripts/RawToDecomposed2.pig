...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS DIST_ID,(chararray)$1 AS DST_MILES,(chararray)$2 AS DST_KMS,(chararray)$3 AS RETRACTION_ALLOWED,(chararray)$4 AS EACH_100,(chararray)$5 AS  EACH_ONE,(chararray)$6 AS CREATED_DATE,(chararray)$7 AS UPDATED_DATE,(chararray)$8 AS CREATED_BY,(chararray)$9 AS UPDATED_BY;
