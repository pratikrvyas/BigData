...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS ISO_CODE,(chararray)$1 AS COUNTRY_NAME,(chararray)$2 AS NEW_ISO_CODE,(chararray)$3 AS NEW_COUNTRY,(chararray)$4 AS TERRITORY_NAME,(chararray)$5 AS  NEW_TERRITORY,(chararray)$6 AS CITY_CODE,(chararray)$7 AS CITY;
