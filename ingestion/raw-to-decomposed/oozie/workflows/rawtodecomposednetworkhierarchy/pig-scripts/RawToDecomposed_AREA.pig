...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS AREA,(chararray)$1 AS NEW_AREA,(chararray)$2 AS AREA_CODE,(chararray)$3 AS NEW_AREA_CODE,(chararray)$4 AS REGION,(chararray)$5 AS  NEW_REGION,(chararray)$6 AS REGION_CODE,(chararray)$7 AS NEW_REGION_CODE ;
