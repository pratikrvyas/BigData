...
rawdata_column = FOREACH rawdata  GENERATE (chararray)$0 AS Operating_Carrier_BCD_Code,(chararray)$1 AS Marketing_Carrier_BCD_Code,(chararray)$2 AS EK_RBD,(chararray)$3 AS OAL_RBD,(chararray)$4 AS Effective_Date,(chararray)$5 AS Discontinue_Date;
