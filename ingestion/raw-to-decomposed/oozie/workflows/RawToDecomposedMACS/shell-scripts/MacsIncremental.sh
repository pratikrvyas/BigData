...
echo "HOST=`hostname`"
echo "PWD=`pwd`"
echo "HADOOPNAMENODEPATH=$HADOOPNAMENODEPATH"
...
str=`date +%s`
echo "str :::  $str"
echo "Command ::: hadoop jar SeqToAvroUuid.jar com.emirates.helix.macs.driver.SeqXmlToAvroUuid $PROCESSINGDIR $DECOMPOSEDDIR/$str $SCHEMADIR $HADOOPNAMENODEPATH"
# sudo -u scv_ops hadoop jar SeqToAvroUuid.jar com.emirates.helix.macs.driver.SeqXmlToAvroUuid $PROCESSINGDIR $DECOMPOSEDDIR/$str $SCHEMADIR $HADOOPNAMENODEPATH
hadoop jar SeqToAvroUuid.jar com.emirates.helix.macs.driver.SeqXmlToAvroUuid $PROCESSINGDIR $DECOMPOSEDDIR/$str $SCHEMADIR $HADOOPNAMENODEPATH
