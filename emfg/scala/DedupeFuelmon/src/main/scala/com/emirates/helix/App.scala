...
object DedupFuelMonMain {
  ...
  def main(args : Array[String]) {
    ...
    DedupFuelMonData.decompdataprocess(base_Input_Path: String, incr_Input_path: String, hist_Output_Path: String,inct_Output_Path: String, incr_Output_Path_Temp: String, loadType: String, months: Integer);
  }
