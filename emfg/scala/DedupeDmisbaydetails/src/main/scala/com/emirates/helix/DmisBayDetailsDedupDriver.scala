 ...
 * Filename    : DmisBayDetailsDedupDriver.scala
...
/**
  * DmisBayDetailsDedupDriver class with main method for starting point for the app
  */
object DmisBayDetailsDedupDriver {
  private val compress_rex = """^snappy$|^deflate$""".r
  private val format_rex = """^avro$|^parquet$""".r

  private lazy val logger:Logger = Logger.getLogger(DmisBayDetailsDedupDriver.getClass)
  ...
  def main(args:Array[String]) : Unit = {
    ...
    val parser = new scopt.OptionParser[Model.DMISBayDetailsArgs]("spark-submit <spark-options> --class com.emirates.helix.DmisBayHistoryDedupDriver" +
